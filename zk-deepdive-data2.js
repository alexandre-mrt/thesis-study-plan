...
window.ZK_DEEPDIVE_SECTIONS_2 = [
   ...
   * ================================================================ */
  {
    ...
    content:
      ...
      'Here is a 2D lattice with basis \\(\\mathbf{b}_1 = (2, 1)\\) and \\(\\mathbf{b}_2 = (0, 3)\\):</p>' +
      ...
      '    0    2    4    6    8   10\n' +
      '  \n' +
      '  Every point = z₁·b₁ + z₂·b₂  where z₁, z₂ ∈ ℤ\n' +
      '  Example: (4, 5) = 2·(2,1) + 1·(0,3) = (4,2)+(0,3)\n' +
      '  \n' +
      '  ★ = target point (3.1, 2.8)\n' +
      '  Closest lattice point? → (4, 2) or (2, 4)?\n' +
      '  In 2D: easy.  In 500D: IMPOSSIBLE (even for quantum).' +
      '</pre>' +
    ...
    diagram:
      ...
      '  \n' +
      '  A 2D LATTICE (basis b₁=(2,1), b₂=(0,3))\n' +
      '  \n' +
      '  y\n' +
      '  6 ┤  ●────────●────────●────────●\n' +
      '    │  │         │         │         │\n' +
