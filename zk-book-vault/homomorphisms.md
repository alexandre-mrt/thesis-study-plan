...
This concept was already taught in our article on [[finite-fields]], but we didn’t use the term “homomorphism” to describe it.
...
I know this may seem like a huge tangent, but trust me, understanding “homomorphism” enables us to succinctly describe a concept that we will regularly see. It will also come in handy again when we discuss [[quadratic-arithmetic-program|Quadratic Arithmetic Programs]]. Homomorphisms appear frequently in the ZK world.
...
The good news is, we are done with our treatment of abstract algebra, and we now have a strong foundation to move on to [[elliptic-curve-addition|elliptic curves]].
