...
A zero knowledge proof for an R1CS is accomplished by converting the witness vector into [[elliptic-curves-finite-fields|finite field elliptic curve points]] and replacing the Hadamard product with a [[bilinear-pairing]] for each row.
