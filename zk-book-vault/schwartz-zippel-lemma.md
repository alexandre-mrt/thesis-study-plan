...
![[schwartz-zippel-x-x2-example-09f1fafb.png|Plot of y = x and y = x^2]]
...
![[schwartz-zippel-x-x3-example-57c10397.png|Plot of y = x^3 and y = x]]
...
But before we get to that, we need to learn how to represent an entire arithmetic circuit as a small set of polynomials evaluated at a random point, which is the motivation for [[quadratic-arithmetic-program|Quadratic Arithmetic Programs]].
