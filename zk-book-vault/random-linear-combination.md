...
If we have elliptic curve points $G$ and $B$ with unknown discrete logs, and blinding terms $\alpha$ and $\beta$ we can construct [[pedersen-commitment|Pedersen committments]] $L$ and $R$ where
...
*This tutorial is part of a series on [ZK Bulletproofs](https://rareskills.io/post/rareskills.io/post/bulletproofs-zk).*
