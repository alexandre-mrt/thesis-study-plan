...
![[935a00_71d5fe7538a847ccaef0c82b5bea6b57_mv2-ece7511e.jpeg|Image of a chess board]]
...
![[935a00_697037a2589d4091a95a9123d3796b4c_mv2-27d6eee1.png|An incomplete sudoku puzzle]]

![[935a00_2b17812514524ee584f0d9e7c340c73f_mv2-d708e3e3.png|A completed sudoku puzzle]]
...
![[935a00_80bcbb69d39348819f674827b8c25691_mv2-a717b10d.png|A map of the United States colored with four colors]]
...
![[935a00_5ddfcf6c6b0f4920bdb3624fbab031d9_mv2-7a73c5d3.jpg|A map showing Nevada and the surrounding states]]
...
![[935a00_d8396ac3cd15406281b6c83deb2abc71_mv2-26f88f6e.jpg|A 3 Coloring of Australia]]
...
![[935a00_9a3130175f2945eb8ae7a4d975b36f55_mv2-e977309b.jpg|Hierarchy of computation complexity classes]]
...
![[935a00_4dc4955706b54e778847f861f651e486_mv2-1053f7ca.gif|Algorithm to test if P is greater or equal to Q]]

If $P = Q$, then all of the bits are equal. $P = Q$ means $P ≥ Q$ is also true:  
![[935a00_186a696a8b14493a8d6cd17d7f7bfe0d_mv2-f2ca1741.gif|Algorithm to test P = Q]]

If P < Q, then we will detect that on the first bit where Q is 1 and P is 0:

![[935a00_bba4e16f05d34184945faf33fd9a8c53_mv2-c563f201.gif|Detecting if P < Q]]
...
(WA\_G ∧ ¬WA\_B ∧ ¬WA\_R) ∨ (¬WA\_G ∧ WA\_B ∧ ¬WA\_R) ∨ (¬WA\_G ∧ ¬WA\_B ∧ WA\_R)
...
¬(WA\_G ∧ SA\_G) ∧ ¬(WA\_B ∧ SA\_B) ∧ ¬(WA\_R ∧ SA\_R)
...
![[935a00_824140c195b64b20bb5351d8d54464d8_mv2-46eecf67.jpg|3-coloring of Australia labelled with colors for the territories]]
...
1. (WA\_G ∧ ¬WA\_B ∧ ¬WA\_R) ∨ (¬WA\_G ∧ WA\_B ∧ ¬WA\_R) ∨ (¬WA\_G ∧ ¬WA\_B ∧ WA\_R)
2. (SA\_G ∧ ¬SA\_B ∧ ¬SA\_R) ∨ (¬SA\_G ∧ SA\_B ∧ ¬SA\_R) ∨ (¬SA\_G ∧ ¬SA\_B ∧ SA\_R)
3. (NT\_G ∧ ¬NT\_B ∧ ¬NT\_R) ∨ (¬NT\_G ∧ NT\_B ∧ ¬NT\_R) ∨ (¬NT\_G ∧ ¬NT\_B ∧ NT\_R)
4. (Q\_G ∧ ¬Q\_B ∧ ¬Q\_R) ∨ (¬Q\_G ∧ Q\_B ∧ ¬Q\_R) ∨ (¬Q\_G ∧ ¬Q\_B ∧ Q\_R)
5. (NSW\_G ∧ ¬NSW\_B ∧ ¬NSW\_R) ∨ (¬NSW\_G ∧ NSW\_B ∧ ¬NSW\_R) ∨ (¬NSW\_G ∧ ¬NSW\_B ∧ NSW\_R)
6. (V\_G ∧ ¬V\_B ∧ ¬V\_R) ∨ (¬V\_G ∧ V\_B ∧ ¬V\_R) ∨ (¬V\_G ∧ ¬V\_B ∧ V\_R)
...
¬(WA\_G ∧ NT\_G) ∧ ¬(WA\_B ∧ NT\_B) ∧ ¬(WA\_R ∧ NT\_R)

9. Northern Territory and South Australia:

¬(NT\_G ∧ SA\_G) ∧ ¬(NT\_B ∧ SA\_B) ∧ ¬(NT\_R ∧ SA\_R)

10. Northern Territory and Queensland:

¬(NT\_G ∧ Q\_G) ∧ ¬(NT\_B ∧ Q\_B) ∧ ¬(NT\_R ∧ Q\_R)

11. South Australia and Queensland:

¬(SA\_G ∧ Q\_G) ∧ ¬(SA\_B ∧ Q\_B) ∧ ¬(SA\_R ∧ Q\_R)

12. South Australia and New South Wales:

¬(SA\_G ∧ NSW\_G) ∧ ¬(SA\_B ∧ NSW\_B) ∧ ¬(SA\_R ∧ NSW\_R)

13. South Australia and Victoria:

¬(SA\_G ∧ V\_G) ∧ ¬(SA\_B ∧ V\_B) ∧ ¬(SA\_R ∧ V\_R)

14. Queensland and New South Wales:

¬(Q\_G ∧ NSW\_G) ∧ ¬(Q\_B ∧ NSW\_B) ∧ ¬(Q\_R ∧ NSW\_R)

15. New South Wales and Victoria:

¬(NSW\_G ∧ V\_G) ∧ ¬(NSW\_B ∧ V\_B) ∧ ¬(NSW\_R ∧ V\_R)
...
Please see the [[ZK Book|RareSkills ZK Book]] for more topics in zero knowledge proofs.
