...
For all math here, we assume we are working in a [[finite-fields|finite field]], but we skip the $\mod p$ notation for succinctness.
...
We can think of both vectors under element-wise addition (in a finite field) and polynomials under addition (also in a finite field) as [[group-theory|groups]].
...
![[36b3e7afd5e2b2e0-qap-3-point-cross-aaa947db.png|3 point intersection of u, v, and w]]
...
![[23d1278e97057bbc-qap-zero-polynomial-9f70b060.png|zero polynomial plot]]
...
In the next chapter, we will show Python code to [[r1cs-to-qap|convert an R1CS to a QAP]] based on our discussion in this chapter.
