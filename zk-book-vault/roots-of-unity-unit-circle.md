...
![[image3-f0a230d2.jpg|The numbers 0 to 3 evenly spaced around a circle]]
...
![[image1-dc0d1cda.jpg|A diagram showing the equivalence between multiplying by omega and taking a step around the unit circle.]]
...
![[image2-c24aa6e4.jpg|Showing that omega exponents are addition modulo 4]]

If we multiply $\omega^3$ and $\omega^2$, we will get $\omega^5$, which is congruent to $\omega$, exactly as the chart suggests:

![[image4-7e6de53a.jpg|An example of adding exponents on the unit circle is equivalent to multiplying the roots of unity.]]

Another way to think about this is starting at $\omega^2$ and taking 3 steps forward:

![[image9-dc030ebb.gif|An animation showing three steps along the unit circle from omega^2 to omega^1]]
...
![[image5-4ca44635.jpg|additive inverses are on opposite sides]]
...
![[image6-09839542.jpg|unit circle with the 8-th roots of unity]]

### k = 6

![[image8-d6cd2340.jpg|unit circle with the 6-th roots of unity]]

### k = 16

![[image7-cd761ebd.jpg|roots of unity with the 16-th roots of unity]]
